...
| 16 | `OSideMedia/higgsfield-ai-prompt-skill` | `c0b73ab946df6658cca513db78bdc3909a655bfd` | MIT | Bolt-on prompt skill: Seedance 2.5 references, Kling 3.0, UGC templates, identity/Soul handling, model specs | `SKILL.md`; `skills/`; `specs/`; `docs/`; `LICENSE`. Merged 2026-09-18 as `skills/higgsfield/` + Agents cards; upstream agent-facing rules are reference-only inside Buffer Blaster. |
| 17 | `Goku-OpenLab/seedance-2-prompts-datasets` | `6664a7bb9ff262faf8b009c752a4997488eba7f9` | CC-BY-4.0 | Seedance 2 prompt dataset for retrieval and benchmarks (8,755 records, 7,360 unique after dedupe) | `metadata.jsonl`; `LICENSE`. Merged 2026-09-18 via `jsonl-dataset` adapter into `library/imported/goku-openlab/`; media stays on Hugging Face (preview URLs only). |
| 18 | `YouMind-OpenLab/awesome-seedance-2-prompts` | `6f4ac511c508bcca3dbfe9f1c88ebd46557b9133` | CC-BY-4.0 | Curated Seedance 2 prompt collection for retrieval and benchmarks (107 entries, 106 unique after dedupe) | `README.md` (featured + All Prompts sections); `LICENSE`. Merged 2026-09-18 via `numbered-readme` + new `titled-readme` adapters into `library/imported/youmind/`. |
| 19 | `Autom8AI/Open-Higgsfield-AI` | `b578108936e83a3b2a5e86644057a56f8aea73a1` | README describes the project as MIT/open source; no upstream code copied into this slice | Model-catalog + submit/poll interface pattern for the universal gateway | `README.md`; `packages/studio/src/models.js`; `packages/studio/src/muapi.js`. Adoption type: concept + interface-pattern. Excluded: UI, browser localStorage key handling, MuAPI billing/account logic. Buffer Blaster owner: `api/services/universal_media_gateway.py`. Human gate: model allowlist + wallet reservation + explicit generation approval. |
| 20 | `samagra14/mediagateway` | `8e6a809643c97f22b541b44d3a8cacdcc4b61c89` | MIT per pinned README badge/text | OpenAI-compatible multi-provider video gateway / BYOK concept | `README.md`. Adoption type: concept only. No code copied. Buffer Blaster keeps its own provider contract, receipts, wallet, and approval gates. |
| 21 | `AngeVox/AngeMedia-gateway` | `2986b8c75c9df723743bc0291e5d23bf7c8cc836` | License not established from inspected pinned README; reference-only | Async `POST /v1/videos` + polling interface reference | `README.md`. Adoption type: concept only. No code copied. Human gate remains Buffer Blaster approval/wallet authority. |
| 22 | `yolorouter/yolorouter` | `b223749986588d89e81db62f98aef8dd0d2f70a8` | Apache-2.0 per pinned README badge | Sovereign OpenAI video gateway, model aliasing, Volcengine/Seedance/Kling/MiniMax routing reference | `README.md`. Adoption type: concept only. No code copied. Provider-native billing and admin console excluded. |
| 23 | `calesthio/OpenMontage` | `08e2151fa02de28a5d6a312b3d575692bf147ad7` | AGPLv3 per pinned README badge; reference-only unless separately approved | Broad provider-adapter/orchestration reference | `README.md`. Adoption type: concept only. No AGPL code copied. Buffer Blaster does not import OpenMontage runtime/UI. |
| 24 | `gateway/media-studio` | `b75bd74dd2c03fd6d90d5aad05a85ddeb63cd664` | License not established from inspected pinned README; reference-only | Catalog-driven KIE media model/pricing reference including Seedance 2.5 | `README.md`. Adoption type: concept only. No code copied; KIE-specific billing/UI excluded. |
| 25 | `ai-models-lab/seedance-2.5` | `00a5c98dea49d7bab8a356d8fe29b490bdf2f1f9` | README links a license but exact license text was not inspected in this review; reference-only | Seedance 2.5 provider-path reference (Volcengine Ark / Fal / Replicate) | `README.md`. Adoption type: concept only. No code copied; exact provider IDs, pricing, and commercial terms require runtime verification. |
