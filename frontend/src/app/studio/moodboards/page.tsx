...
export default function MoodboardsPage() {
  ...
  return <StudioShell eyebrow="Reference system">
    <PageHeader kicker="Moodboards" title="Save visual references." body="Add product shots and creative references." action={<StatusPill tone={assets.length ? "green" : "neutral"}>{assets.length} references</StatusPill>} />
