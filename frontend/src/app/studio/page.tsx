...
export default function StudioOverview() {
  ...
  return <StudioShell eyebrow="Agentic social operations">
    <PageHeader kicker="Today" title="Make your next ad." body="Plan, review, and render. Publishing stays separate." action={<Link href="/studio/create" className="inline-flex items-center gap-2 rounded-full bg-black px-5 py-3 text-sm font-medium text-white"><Plus className="h-4 w-4" />Create</Link>} />
    <div className="space-y-6 p-6 lg:p-10">
      ...
      <section className="rounded-[22px] border border-black/7 bg-white p-5 shadow-[0_16px_45px_rgba(0,0,0,.035)]">
        <div className="flex items-center justify-between"><div><p className="text-xs text-black/40">Recent work</p><h3 className="mt-1 text-xl font-semibold tracking-tight">Recent ads</h3></div><Link href="/studio/library" className="text-xs font-medium text-black/50 hover:text-black">View library</Link></div>
